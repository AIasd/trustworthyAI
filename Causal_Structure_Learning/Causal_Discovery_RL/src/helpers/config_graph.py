...
data_arg.add_argument('--gamma', type=float, default=0.2, help='gamma')
data_arg.add_argument('--use_ppo', type=int, default=1, help='use_ppo')
data_arg.add_argument('--epsilon', type=float, default=0.2, help='epsilon')
